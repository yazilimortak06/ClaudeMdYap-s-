...
using Api.Application.Services.PanelServices.SupportManagment;
...
namespace Web.Api.Controllers
{
    ...
    public class SupportManagmentController : ControllerBase
    {
        ...
        public SupportManagmentController(IConfiguration configuration,
                                           ISupportManagmentService supportManagmentService)
        {
