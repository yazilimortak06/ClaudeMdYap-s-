...
using Api.Application.Services.PanelServices.ChargeDeviceManagment;
...
namespace Web.Api.Controllers
{
    ...
    public class DeviceRemoteManagmentController : ControllerBase
    {
        ...
        public DeviceRemoteManagmentController(IConfiguration configuration,
            IChargeDeviceRemoteManagmentService chargeDeviceRemoteManagmentService)
        {
