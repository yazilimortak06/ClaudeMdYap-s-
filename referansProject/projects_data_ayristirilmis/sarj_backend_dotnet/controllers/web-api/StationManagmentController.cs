...
namespace Web.Api.Controllers
{
    ...
    public class StationManagmentController : ControllerBase
    {
        ...
        public StationManagmentController(IStationManagmentService stationManagmentService,
        ...
        [HttpPost]
        [ProducesResponseType(typeof(Result<Result<GetPanelStationForUpdateResponseDto>>), statusCode: 200)]
