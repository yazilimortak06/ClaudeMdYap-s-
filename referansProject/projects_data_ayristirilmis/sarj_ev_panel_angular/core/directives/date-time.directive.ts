...
// Pattern: DateTime Directive — moment.js ile Türkiye timezone dönüşümü, NG_VALUE_ACCESSOR ile form entegrasyonu
...
export class DateTimeDirective {
    ...
    registerOnDateChange(fn: () => void): void { debugger; this.onDateChange = fn; }
}
