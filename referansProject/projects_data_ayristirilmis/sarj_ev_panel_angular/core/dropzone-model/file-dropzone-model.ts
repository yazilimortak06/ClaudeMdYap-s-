...
// Pattern: FileDropZoneData Model — dropzone bileşeni için dosya veri modeli,
// url, guid, fileType, onUploaded, oldfile, uploadError durumları,
// reUploadFunction ve downloadFunction callback'leri
