// Kaynak: E:\Projeler\Angular\EvTechPanelAltunkaya\src\app\core\date-core\MOMENT_DATE_FORMATS.ts
...
export class MomentDateAdapter extends DateAdapter<Moment> {
  ...
  parse(value: any, parseFormat: string | string[]): Moment | null {
    if (value && typeof value == 'string') { return moment(value, parseFormat, this.locale); }
