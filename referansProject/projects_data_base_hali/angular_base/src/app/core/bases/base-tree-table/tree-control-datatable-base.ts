...
export class TreeDataTableControlBase extends TreeControlBase {
    ...
    public setDataSource(data: TreeControlDataTableDataInterface[], totalRecordSize: number): void {
    ...
    private addSubValue(items: TreeControlDataTableDataInterface[], added: TreeControlDataTableDataInterface[]): TreeControlDataTableDataInterface[] {
        let donen = items;
        var isExists = false;
        added.forEach(iiSub => {
            isExists = false;
