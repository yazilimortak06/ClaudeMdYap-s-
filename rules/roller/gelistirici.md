...
- `projectDesignAnalizTaskArge/projects/<proje>/design/yapilacak_design/` (frontend projeleri — UI kodu yazmadan önce oku)
- `projectDesignAnalizTaskArge/projects/<proje>/design/yapilacak_design/oncelik_sirasi.md` (önce hangi ekran)
